...
import { staffStatus, type StaffStatus, staffStatusHistory, type StaffStatusHistory, stores, type Store, type InsertStore, stylistAliases, type StylistAlias } from "../drizzle/schema";
